...
<div class="section glass"><div class="sectionHead"><div><h2>Connection</h2></div></div><div class="infoGrid"><div class="info"><span class="label">Device</span><b id="device">)HTML";
  html += esc(deviceName);
...
<div class="mode glass" aria-label="USB interface"><button id="scanMode" onclick="setInterfaceMode('scanner')"><span class="modeIcon">⌕</span>Scanner interface</button><button id="printMode" class="active" onclick="setInterfaceMode('printer')"><span class="modeIcon">▣</span>Printer interface</button>
