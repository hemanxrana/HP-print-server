...
private:
  ...
  void scanSNMP(PrinterEndpoint *results, size_t capacity, size_t &count, uint32_t timeoutMs);
  void scanMDNS(PrinterEndpoint *results, size_t capacity, size_t &count);
};
